...
const BASE_FIELDS = [
  ...
  ['MEMBERSHIP_PUBLIC_BASE_URL','Public Railway URL (https://...)','text','Memberships'],
  ['MEMBERSHIP_GUILD_ID','Discord server ID','text','Memberships'],
  ['MEMBERSHIP_GOOGLE_CLIENT_ID','Google OAuth client ID','text','Memberships'],
  ['MEMBERSHIP_GOOGLE_CLIENT_SECRET','Google OAuth client secret','password','Memberships'],
  ['MEMBERSHIP_DISCORD_CLIENT_ID','Discord application ID','text','Memberships'],
  ['MEMBERSHIP_DISCORD_CLIENT_SECRET','Discord OAuth client secret','password','Memberships'],
  ['MEMBERSHIP_ENCRYPTION_KEY','Credential encryption key','password','Memberships'],
  ['MEMBERSHIP_STATE_SECRET','Secure link signing secret','password','Memberships'],
  ['MEMBERSHIP_SYNC_MINUTES','Automatic membership sync interval (minimum 15)','number','Memberships'],
