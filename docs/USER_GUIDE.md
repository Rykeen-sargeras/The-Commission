...
- Use `/membership-help` for the privacy and grace explanation.

The creator separately authorizes the official YouTube membership endpoint. The bot does not receive a Google password or store an email address. A technical outage never counts as cancellation. Confirmed absence enters the server's grace period before a role can be removed.
